...
export function MicToggle({ open, onToggle, level }: Props) {
  const { t } = useT();
    ...
    >
      <div
        className={[
          ...
          open ? "bg-white/20" : "bg-zinc-900 text-zinc-400 group-hover:bg-zinc-800",
        ].join(" ")}
      >
      ...
      <div className="flex flex-1 flex-col items-start gap-1.5">
        ...
        <div className={`relative h-1.5 w-full overflow-hidden rounded-full ${open ? "bg-white/20" : "bg-zinc-900"}`}>
          <div
