...
export function DevicePill({ value, onChange }: Props) {
  const { t } = useT();
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full z-50 mt-2 w-72 overflow-hidden rounded-xl bg-zinc-900 shadow-2xl ring-1 ring-zinc-800">
